...
namespace Violet
{
    ...
    extern void SetShaderMatrix4x2     (const std::string& name, const Matrix4x2& mat);
    extern void SetShaderMatrix4x3     (const std::string& name, const Matrix4x3& mat);
    ...
    extern void SetShaderMatrix4x2Array(const std::string& name, std::initializer_list<Matrix4x2> mats);
    extern void SetShaderMatrix4x3Array(const std::string& name, std::initializer_list<Matrix4x3> mats);

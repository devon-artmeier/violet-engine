...
namespace Violet
{
    ...
    /*extern void SetShaderMatrix2x2(const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix3x3     (const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix2x3     (const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix3x2     (const std::string& name, const uint count, const float* const value);
    ...
    /*extern void SetShaderMatrix2x2Array(const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix3x3Array(const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix2x3Array(const std::string& name, const uint count, const float* const value);
    extern void SetShaderMatrix3x2Array(const std::string& name, const uint count, const float* const value);

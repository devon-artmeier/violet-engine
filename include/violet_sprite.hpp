...
namespace Violet
{
    ...
    extern void DrawSprite            (const std::string& id, const uint layer, const uint frame, const Vector2& pos, const float angle = 0.0f, const Vector2& scale = Vector2(1.0f));
}

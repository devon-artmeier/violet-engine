...
namespace Violet
{
    ...
    Matrix2x2::Matrix2x2(const float value1, const float value2, const float value3, const float value4)
    {
    ...
    Matrix2x2::Matrix2x2(const float arr1[2], const float arr2[2])
    {

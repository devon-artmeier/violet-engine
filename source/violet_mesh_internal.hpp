...
namespace Violet
{
    class Mesh
    {
        public:
            ...
            void LoadElementData    (const uint* const data, const int offset, const int count);
    ...
    extern void LoadMeshElementData    (const std::string& id, const uint* const data, const int offset, const int count);

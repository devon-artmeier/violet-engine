...
namespace Violet
{
    ...
    Shader::Shader(const std::string& id, const std::string& vertex_code, const std::string& frag_code)
    {
        ...
        Assert(success3 != 0, this->id + ": Failed to link shaders:\n" + log3);
    ...
    void LoadShader(const std::string& id, const std::string& vertex_code, const std::string& frag_code)
    {
        if (GetShader(id) == nullptr) {
            shader_group->shaders.insert({ id, new Shader(id, vertex_code, frag_code) });
        }
    }
    ...
    static void CheckShaderSetFail(const std::string& type_name)
    {
        Assert(shader_group->current_shader != 0, "Tried to set " + type_name + " when no shader is attached");
    }
    ...
    {
        CheckShaderSetFail("4D int vector");
    ...
    {
        CheckShaderSetFail("4D unsigned int vector");
    ...
    {
        CheckShaderSetFail("float array");
    ...
    {
        CheckShaderSetFail("unsigned int array");
    ...
    {
        CheckShaderSetFail("2D vector array");
    ...
    {
        CheckShaderSetFail("2D int vector array");
    ...
    {
        CheckShaderSetFail("2D unsigned int vector array");
    ...
    {
        CheckShaderSetFail("3D vector array");
    ...
    {
        CheckShaderSetFail("3D int vector array");
    ...
    {
        CheckShaderSetFail("3D unsigned int vector array");
    ...
    {
        CheckShaderSetFail("4D vector array");
    ...
    {
        CheckShaderSetFail("4D int vector array");
    ...
    {
        CheckShaderSetFail("4D unsigned int vector array");
    ...
    {
        CheckShaderSetFail("2x2 matrix array");
    ...
    {
        CheckShaderSetFail("2x3 matrix array");
    ...
    {
        CheckShaderSetFail("2x4 matrix array");
    ...
    {
        CheckShaderSetFail("3x2 matrix array");
        Pointer<float> values = new float[mats.size() * 6];
        int i = 0;
    ...
    {
        CheckShaderSetFail("3x3 matrix array");
    ...
    {
        CheckShaderSetFail("3x4 matrix array");
    ...
    {
        CheckShaderSetFail("4x2 matrix array");
        Pointer<float> values = new float[mats.size() * 8];
        int i = 0;
    ...
    {
        CheckShaderSetFail("4x3 matrix array");
        Pointer<float> values = new float[mats.size() * 12];
        int i = 0;
    ...
    {
        CheckShaderSetFail("4x4 matrix array");

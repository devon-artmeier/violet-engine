...
namespace Violet
{
    ...
    IVector3 IVector3::operator*(const Matrix3x3& mat) const
    {
        return IVector3((this->data[0] * mat[0][0]) + (this->data[1] * mat[1][0]) + (this->data[2] * mat[2][0]),
    ...
    IVector3& IVector3::operator*=(const Matrix3x3& mat)
    {
